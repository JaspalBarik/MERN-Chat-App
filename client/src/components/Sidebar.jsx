 ...
 const { getUsers, users, selectedUser, setSelectedUser,
  ...
  return (
    ...
    py-3 px-4 mt-5">
      ...
      text-white test-xs placeholder-[#c8c8c8] flex-1" placeholder="Search User..."/>
    </div>
       ...
       'bg-[#282142]/50'}`}>
        ...
        <div className="flex flex-col leading-5">
         <p>{user.fullName}</p>
         {
          ...
          {
           unseenMessages[user._id] > 0 && <p className="absolute top-4 right-4 text-xs h-5 
            w-5 flex justify-center items-center rounded-full bg-violet-500/50">
